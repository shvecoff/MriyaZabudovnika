      ...
      <section>
        <div className="container">
          ...
          <div className="furnitura__flex">
            <Swiper className="furnitura__slider" slidesPerView={"auto"} loop={true} navigation={{
